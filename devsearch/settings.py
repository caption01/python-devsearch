...
SECRET_KEY = 'django-insecure-pg(!dibj8dccxma@*@y7nikwu0&z%h9#p-%!_3(#3^9vsnr9y#'
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'postgres',
        'HOST': 'database-1.c3t0kwmmbnmr.ap-southeast-1.rds.amazonaws.com',
        'PORT': '5432'
    }
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'nutchapon.dev@gmail.com'
EMAIL_HOST_PASSWORD = 'nfijtaktvdkpckro'
